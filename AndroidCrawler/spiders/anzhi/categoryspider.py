...
from AndroidCrawler.spiders.anzhi.newspider import NewSpider
from AndroidCrawler.db.anzhi import SqlAnZhi
from AndroidCrawler.items import AnZhiItem


class CategorySpider(NewSpider):
    """category spider for Market_Anzhi"""

    name = 'Market_Anzhi.categoryspider'
    market = 'Market_Anzhi'
    ...
    def _init_start_urls(self):
        self.start_urls.append('http://www.anzhi.com/list_1_1_hot.html')
        self.start_urls.append('http://www.anzhi.com/list_2_1_hot.html')
        self.start_urls.append('http://www.anzhi.com/list_1_1_new.html')
        self.start_urls.append('http://www.anzhi.com/list_2_1_new.html')
        self.start_urls.extend(['http://www.anzhi.com/sort_{0}_1_{1}.html'.format(category, rank) for category in self.categorys for rank in ['hot', 'new']])
